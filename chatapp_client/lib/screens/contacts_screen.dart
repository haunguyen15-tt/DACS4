...
class _ContactsScreenState extends State<ContactsScreen> {
  ...
  _getContacts() async {
    ...
    List<dynamic> verifiedContacts =
        await ContactsApi.getVerifiedContacts(token);
    print('1233 $verifiedContacts');
    verifiedContacts.forEach((element) {
      // print(element is Map);
      contacts.add(ContactModel.fromJson(element));
    });
    print(contacts[0].name);
    // contacts.add(verifiedContacts)
    setState(() {
      _isLoading = false;
    });
  }
