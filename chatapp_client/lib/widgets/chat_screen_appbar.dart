...
class _ChatAppBarState extends State<ChatAppBar> {
  ...
  void sendMessage() async {
    ...
    // print(message);
    var channelName = selectedUser.email;
    var res = await AuthenticationApi.generateAgoraToken(channelName);
    var body = json.decode(res.body);
    var user = await SharedPreferencesHelper.getUser();
    await SharedPreferencesHelper.setAgoraToken(body['token'], channelName);
    print(user['_id']);
    await socketIO.sendMessage(
      'start_call',
      json.encode({
        'call_id': selectedUser.email,
